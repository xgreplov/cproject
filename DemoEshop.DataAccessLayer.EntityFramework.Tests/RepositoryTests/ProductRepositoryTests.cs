...
namespace DemoEshop.DataAccessLayer.EntityFramework.Tests.RepositoryTests
{
    public class ProductRepositoryTests
    {
        ...
        private readonly IRepository<Song> productRepository = Initializer.Container.Resolve<IRepository<Song>>();
        ...
        public async Task GetProductAsync_AlreadyStoredInDBWithIncludes_ReturnsCorrectProductWithInitializedParent()
        {
            ...
            using (unitOfWorkProvider.Create())
            {
                samsungGalaxyJ7Product = await productRepository.GetAsync(samsungGalaxyJ7Id, nameof(Song.Category));
            }
        ...
        {
            Song updatedAndroidProduct;

            var newSamsungGalaxyJ7 = new Song
            {
