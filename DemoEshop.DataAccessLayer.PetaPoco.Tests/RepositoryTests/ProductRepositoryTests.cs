...
namespace DemoEshop.DataAccessLayer.PetaPoco.Tests.RepositoryTests
{
    public class ProductRepositoryTests
    {
        ...
        public async Task UpdateProductAsync_ProductIsPreviouslySeeded_UpdatesProduct()
        {
            ...
            Assert.IsTrue(newSamsungGalaxyJ7.Name.Equals(updatedAndroidProduct.Name) && 
                newSamsungGalaxyJ7.DiscountPercentage.Equals(updatedAndroidProduct.DiscountPercentage) &&
                newSamsungGalaxyJ7.StoredUnits == updatedAndroidProduct.StoredUnits);
        }
